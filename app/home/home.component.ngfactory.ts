...
export function viewFactory_HomeComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.HomeComponent> {
  if ((renderType_HomeComponent === (null as any))) { (renderType_HomeComponent = viewUtils.createRenderComponentType('/Users/stefanaerts/dev/angular2-aot-webpack2-rollup/app/home/home.component.ts class HomeComponent - inline template',0,import8.ViewEncapsulation.None,styles_HomeComponent,{})); }
